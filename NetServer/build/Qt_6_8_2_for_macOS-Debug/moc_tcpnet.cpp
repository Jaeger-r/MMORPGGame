...
static constexpr auto qt_meta_stringdata_ZN6TCPNetE = QtMocHelpers::stringData(
    "TCPNet",
    "dataReceived",
    "",
    "QTcpSocket*",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6TCPNetE[] = {
...
Q_CONSTINIT const QMetaObject TCPNet::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6TCPNetE.offsetsAndSizes,
    qt_meta_data_ZN6TCPNetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6TCPNetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TCPNet, std::true_type>,
        // method 'dataReceived'
...
void TCPNet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TCPNet::*)(QTcpSocket * , QByteArray );
            if (_q_method_type _q_method = &TCPNet::dataReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TCPNet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6TCPNetE.stringdata0))
...
// SIGNAL 0
void TCPNet::dataReceived(QTcpSocket * _t1, QByteArray _t2)
{
